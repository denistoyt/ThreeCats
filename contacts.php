<? require_once('php/connect.php'); require_once('functions/info.php'); require_once('functions/info.php'); ?>
<!DOCTYPE html>
<html lang="ru">
<head>
	<meta charset="UTF-8">
            ...
            <div class="contacts-content">
                ...
                <div class="contacts-info">
                    ...
                    <div class="contacts-info__row">
                        <p class="contacts-info-title">График работы</p>
                        <p class="contacts-info-text">Ежедневно:  <? footerSchedule($schedule[0], $schedule[1]); ?></p>
                    </div>
                    <!-- Строчка -->
                    <div class="contacts-info__row">
                        <p class="contacts-info-title">Адрес</p>
                        <p class="contacts-info-text"><?= $address; ?></p>
                    </div>
                    <!-- Строчка -->
                    <div class="contacts-info__row">
                        <p class="contacts-info-title">Телефон</p>
                        <div class="contacts-info-tels">
                            <a href="tel:<?= $tel[0]; ?>" class="contacts-info-text"><?= $tel[0]; ?></a>
                            <a href="tel:<?= $tel[1]; ?>" class="contacts-info-text"><?= $tel[1]; ?></a>
                        </div>
                    </div>
                    <!-- Строчка -->
                    <div class="contacts-info__row">
                        <p class="contacts-info-title">Социальные сети</p>
                        <div class="contacts-info-soc">
                            <a href="https://ok.ru/profile/560775933088" target="_blank" class="soc-icon soc-icon-ok-36"></a>
                        </div>
                    </div>
                </div>
                <!-- карта -->
