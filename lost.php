<? require_once('php/connect.php'); require_once('functions/lost.php'); require_once('functions/info.php'); ?>
<!DOCTYPE html>
<html lang="ru">
<head>
	<meta charset="UTF-8">
	...
	<main>
        ...
        <div class="breadcrumb">
            <ul class="container">
                ...
                <li><a href="#" class="active">Потеряшки</a></li>
            </ul>
        </div>
        <!-- Потеряшки -->
        <div class="lost section container">
            <h2 class="sec-title">Потеряшки</h2>
