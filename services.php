<? require_once("php/connect.php"); require_once('functions/info.php'); ?>
<!DOCTYPE html>
<html lang="ru">
<head>
	<meta charset="UTF-8">
	...
	<main>
        ...
        <div class="breadcrumb">
            <ul class="container">
                ...
                <li><a href="#" class="active">Услуги и цены</a></li>
            </ul>
        </div>
        <!-- Услуги и цены -->
        <div class="services section container">
            <div class="services-header">
                <h2 class="sec-title">Услуги и цены</h2>
                <a href="files/price_list.xlsx" download="Прайс-лист(Три Кота).xlsx" class="button1 services-header-btn" id="price-download">Скачать прайс-лист</a>
            </div>
                ...
                <div class="accordion">
                    ...
                    <div class="accordion-content">
                        <table class="accordion-content-table">
                            <thead>
                                <tr>
                                    <th class="accordion-table-title accordion-table-title-1">Оказываемая услуга</th>
                                    <th class="accordion-table-title accordion-table-title-2">Цена, руб.</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="accordion-table-content-title" data-label="Оказываемая услуга">Первичный прием</td>
                                    <td class="accordion-table-content-cost" data-label="Цена, руб.">300,0</td>
                                </tr>
                                <tr>
                                    <td class="accordion-table-content-title" data-label="Оказываемая услуга">Повторный прием</td>
                                    <td class="accordion-table-content-cost" data-label="Цена, руб.">200,0</td>
                                </tr>
                                <tr>
                                    <td class="accordion-table-content-title table-content-list" data-label="Оказываемая услуга">
                                        Иньекция: <br>
										<span>подкожная</span><br>
										<span>внутримышечная</span><br>
										<span>внутривенная</span>
                                    </td>
                                    <td class="accordion-table-content-cost" data-label="Цена, руб.">
										<span></span><br>
										<span>35,0</span><br>
										<span>35,0</span><br>
										<span>60,0</span>
                                ...
                                <tr>
                                    <td class="accordion-table-content-title" data-label="Оказываемая услуга">Капельница внутривенная</td>
                                    <td class="accordion-table-content-cost" data-label="Цена, руб.">390,0</td>
                                </tr>
                                <tr>
                                    <td class="accordion-table-content-title" data-label="Оказываемая услуга">Капельница подкожная</td>
                                    <td class="accordion-table-content-cost" data-label="Цена, руб.">290,0</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
