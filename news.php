<? require_once("php/connect.php"); require_once('functions/news.php'); require_once('functions/info.php'); ?>
<!DOCTYPE html>
<html lang="ru">
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<main>
		...
		<div class="news section container">
            ...
            <div class="news-header">
                ...
                <button class="button1 news-header-btn">Предложить новость</button>
            </div>
            <!-- Контент -->
	...
	<div class="modal modal-news">
		<form class="modal-news-form">
			<h3 class="modals-title">Предложить новость</h3>
			<div class="modal-news-content">
				<!-- Поля -->
				<div class="modal-news__inputs">
					<!-- Тема -->
					<label for="newsTheme" class="input-label">
						Тема*
						<input type="text" name="theme" id="newsTheme" required>
					</label>
					<!-- Текст новости -->
					<label for="newsText" class="input-label">
						Текст новости*
						<textarea name="text" id="newsText" required></textarea>
					</label>
					<!-- Имя -->
					<label for="newsName" class="input-label">
						Имя*
						<input type="text" name="name" id="newsName" required>
					</label>
					<!-- Телефон -->
					<label for="newsTel" class="input-label">
						Телефон*
						<input type="text" name="tel" id="newsTel">
					</label>
				</div>
				<!-- Персональные данные -->
				<p class="modal-news__terms">
					Нажимая на кнопку, вы даёте согласие <br> на
					<a href="#" class="user-terms">обработку своих персональных данных</a>
				</p>
				<!-- Кнопка -->
				<button class="button1 modal-news__send">Отправить</button>
			</div>
		</form>
	</div>
	<!-- предложить новость подтверждение -->
	<div class="modal modal-news-apply">
		<h3 class="modals-title">Спасибо за новость!</h3>
		<p class="modal-news-apply_text">Ваша новость появится на сайте после модерации администратора</p>
		<button class="button1 modal-news-apply_btn">ОК</button>
	</div>
	<!-- оставить заявку -->
