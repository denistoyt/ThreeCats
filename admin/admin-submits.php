<? session_start(); require_once("../functions/submits.php"); require_once("../php/connect.php"); if ($_SESSION['autorized'] == true) {?>
<!DOCTYPE html>
<html lang="ru">
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<main class="admin-content">
        <aside class="admin-panel-menu">
			...
			<a href="admin-submits.php" class="admin-panel-menu-elem admin-menu-submits menu-active">Заявки на прием</a>
        ...
        <div class="admin-panel-content">
			<h1 class="admin-panel-title">Заявки на прием</h1>
			<div class="admin-submits__content">
				<? submits(); ?>
			</div>
        </div>
	</main>
