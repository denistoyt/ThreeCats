...
<body>
	...
	<main class="admin-content">
        <aside class="admin-panel-menu">
			...
			<a href="admin-services.php" class="admin-panel-menu-elem admin-menu-services menu-active">Услуги и цены</a>
        ...
        <div class="admin-panel-content">
			<h1 class="admin-panel-title">Услуги и цены</h1>
			<div class="admin-dev-side">
