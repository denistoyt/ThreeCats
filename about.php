<? require_once("php/connect.php"); require_once('functions/clients.php'); require_once("functions/about.php"); require_once('functions/info.php'); ?>
<!DOCTYPE html>
<html lang="ru">
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<main>
        ...
        <div class="clients section container">
            <h2 class="sec-title">Наши клиенты</h2>
